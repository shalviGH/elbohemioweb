    ...
    <section class="secComida" style="height: auto;">
        ...
        style="height: 290px; width:30%; display:flex; flex-direction:column; justify-content:space-between"      
         js-idProducto="<?php echo $producto['idProductos']; ?>"
            ...
            <?php if($tipoUser !=1){ ?> 
            <form action="../../Controllers/ordenController.php?peticion=addCar&tipo=2" method="POST" class="formCar">
                ...
                <button type="submit" class="btn btn-primary">Ordenar Bebida</button>
                <div class="col-12 col-md-3">
                    <input type="number" name="cantidad" min="1"  class="js-cantidaPro form-control row-1" value="1" width="100px">
                </div>
                <?php  }else{?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrar Nueva Bebida</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="../../Controllers/FoodController.php?peticion=insertar&tipo=2" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <h5 class="modal-title" id="exampleModalLabel">Esta seguro eliminar este producto</h5>
        <form action="../../Controllers/FoodController.php?peticion=eliminar&tipo=2" method="POST">
...
<?php if($tipoUser == 2){
    ...
    text-decoration: none; color:white" href="<?php echo RUTA_URL; ?>Controllers/ordenController.php?peticion=showCar">
    ver carrito <?php  if(isset($_SESSION['proCar'])){ count($_SESSION['proCar']); echo count($_SESSION['proCar']);}else{echo 0; }
        ?>
            <img src="<?php echo RUTA_URL; ?>images/imgCar.png" alt="" width="40px" height="40px" style="border-radius: 50px;">
    </a> 
    </div>
