...
?>
    ...
    <table class="table table-striped table-hover" style="width: 80%; margin:auto;">
        ...
        <tbody>
            ...
            <?php $num = 1;
                foreach($_SESSION['miCompra']   as $compra){  ?>
                <tr>
                    <th scope="row"> <?php echo $num; ?></th>
                    <td><?php echo $compra['nombreUsuario']; ?></td>
                    <td><?php echo $compra['nombre']; ?></td>
                    <td><?php echo $compra['precio']; ?></td>
                    <td><?php echo $compra['cantidad']; ?></td>
                    <td><?php echo $compra['cantidad'] * $compra['precio']; ?></td>
                    <td><?php echo $compra['fecha']; ?></td>
                    <td> <a href="miReporte.php" class="btn btn-success bi bi-file-pdf"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
